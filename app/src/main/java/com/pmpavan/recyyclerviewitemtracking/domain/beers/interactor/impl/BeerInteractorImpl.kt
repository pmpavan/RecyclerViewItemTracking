...
class BeerInteractorImpl @Inject constructor(private val api: BeerApi) : BeerInteractor {
    override fun getBeersListFromApi(type: String?, page: Int, subtype: String?): Single<List<Top>> {
